				...
				<table width="100%" border="1" align="left">
               	...
               	%>
					...
					<div class="leftContent">
                		...
                		if(academicProjectEnquiryList==null){							List <List<NewAcademicProjectEnquiryDTO>>allAcademicProjectEnquiryList=new EnquiryController().getAllAcademicProjectFollowUp(request);
						...
						<div id="academic_enquiry_active_list_div"
							...
							<table border="4" cellpadding="0" cellspacing="0" width="1024px">
								<thead>
									<tr>
										<th width="4%"><a href="#">S.no</a>
										</th>
										<th width="13%"><a href="#">Full Name</a>
										</th>
										<th width="11%"><a href="#">Contact No</a>
										</th>
										<th width="11%"><a href="#">Project Name</a>
										</th>
										<th width="12%"><a href="#">Date Of Delivery</a>
										</th>
										<th width="11%"><a href="#">Enquiry Date</a>
										</th>
										<th width="12%"><a href="#">Reference Name</a>
										</th>
										<th width="12%"><a href="#">Councillor</a>
										</th>
									</tr>
								</thead>
							</table>
							...
							<table border="4" cellpadding="0" cellspacing="0" width="1024px">
								<thead>
									<tr>
										...
										<th width="11%"><a href="#">Course</a>
										</th>
										<th width="12%"><a href="#">Date Of Joining</a>
										</th>
										<th width="14%"><a href="#">Preferred Time</a>
										</th>
										<th width="11%"><a href="#">Enquiry Date</a>
										</th>
										<th width="12%"><a href="#">Reference Name</a>
						...
						<div class="rightContent">
							...
							<table width="100%" align="right" border="1">
								<tr>
									...
									<td width="60%"><select disabled="disabled"
										name="enquiry_purpose" id="id_enquiry_purpose"
										style="width: 160px;" onchange="showEnquiryForm(this)">
											<option value="Visitor">Visitor</option>
											<option value="Training">Training</option>
											<option value="Academic Project" selected="selected">Academic
												Project</option>
								...
								<table width="100%" align="right" border="1">
									<tr>
										...
										<td width="60%"><input type="hidden"
											...
											id="id_academic_project_enquiry_fullname" size="21" />
										</td>
									</tr>
									<tr>
										...
										<td width="60%"><input type="text"
											...
											id="id_academic_project_enquiry_father_name" size="21" />
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="60%"><input type="text"
											...
											id="id_academic_project_enquiry_contact_no" size="21" />
										</td>
									</tr>
									<tr>
										...
										<td width="60%"><input type="text"
											...
											id="id_academic_project_enquiry_email_id" size="21" />
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="60%"><input type="text"
											...
											id="id_academic_project_enquiry_project_name" size="21" />
										</td>
									</tr>
									<tr>
