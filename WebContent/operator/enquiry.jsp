               	...
               	%>
					<script type="text/javascript" language="javascript">
						...
						function createDiv(item, max) {
							for ( var i = 1; i <= max; i++) {
								if ($("#training_enquiry_remark_div" + i).is(
										":visible")) {
								...
								<table width="100%" align="right" border="1">
									<tr>
										...
										<td width="60%"><input type="hidden"
											...
											id="id_training_enquiry_fullname" size="21" />
										</td>
									</tr>
									<tr>
										...
										<td width="60%"><input type="text"
											...
											id="id_training_enquiry_father_name" size="21" />
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										%>
											...
											<div id="id_training_enquiry_college_div"></div>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td width="60%"><input type="text"
											...
											id="id_training_enquiry_contact_no" size="21" />
										</td>
									</tr>
									<tr>
										...
										<td width="60%"><input type="text"
											...
											id="id_training_enquiry_email_id" size="21" />
										</td>
									</tr>
								...
								<table width="100%" border="1" align="right">
									...
									<tr>
										...
										<td width="60%"><input type="text"
											...
											id="id_training_enquiry_referenceId" value="" size="20" />
										</td>
									</tr>
									<tr>
										<td width="40%" align="right">Contact No :</td>
									...
									<tr>
										...
										<td width="60%"><textarea rows="3" cols="17"
												...
												id="id_training_enquiry_reference_note">self</textarea>
										</td>
									</tr>
								</table>
							</div>
